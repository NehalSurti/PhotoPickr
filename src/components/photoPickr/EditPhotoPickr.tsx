...
export default function EditPhotoPickr({
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      formData.append("title", photoPickrData?.title ?? "");
      formData.append("description", photoPickrData?.description ?? "");
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          <div className="mt-4">
            ...
            <Input
              placeholder="Type PhotoPickr title"
              value={photoPickrData?.title ?? ""}
              onChange={(e) =>
                setPhotoPickrData({ ...photoPickrData, title: e.target.value })
              }
            />
          ...
          <div className="mt-4">
            ...
            <Textarea
              placeholder="Type PhotoPickr description"
              value={photoPickrData?.description ?? ""}
              onChange={(e) =>
                setPhotoPickrData({
                  ...photoPickrData,
          ...
          <div className="mt-4">
            ...
            <Input
              ...
              placeholder="Type PhotoPickr name"
            />
